...
test('Check containers class', () => {
  ...
  expect(containerThree).toHaveClass('grid grid-cols-2 gap-4 mb-6')
  expect(containerFour).toHaveClass('grid grid-cols-1 gap-4 mb-6')
  expect(containerFive).toHaveClass('grid grid-cols-1 gap-4 mb-6')
  expect(containerSix).toHaveClass('mb-6')
  expect(containerSeven).toHaveClass('flex justify-center mt-6')
})
