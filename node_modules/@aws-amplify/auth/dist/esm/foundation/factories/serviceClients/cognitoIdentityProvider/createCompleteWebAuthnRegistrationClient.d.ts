import { CompleteWebAuthnRegistrationCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createCompleteWebAuthnRegistrationClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").CompleteWebAuthnRegistrationRequest) => Promise<CompleteWebAuthnRegistrationCommandOutput>;
