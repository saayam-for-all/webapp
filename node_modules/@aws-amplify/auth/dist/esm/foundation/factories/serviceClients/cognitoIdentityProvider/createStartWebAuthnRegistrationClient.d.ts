import { ServiceClientFactoryInput, StartWebAuthnRegistrationCommandOutput } from './types';
export declare const createStartWebAuthnRegistrationClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").StartWebAuthnRegistrationRequest) => Promise<StartWebAuthnRegistrationCommandOutput>;
