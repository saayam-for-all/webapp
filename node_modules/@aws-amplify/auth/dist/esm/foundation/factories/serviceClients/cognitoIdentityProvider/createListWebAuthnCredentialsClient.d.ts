import { ListWebAuthnCredentialsCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createListWebAuthnCredentialsClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").ListWebAuthnCredentialsInput) => Promise<ListWebAuthnCredentialsCommandOutput>;
