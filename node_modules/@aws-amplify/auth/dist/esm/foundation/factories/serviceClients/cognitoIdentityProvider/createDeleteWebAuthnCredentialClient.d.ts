import { DeleteWebAuthnCredentialCommandOutput, ServiceClientFactoryInput } from './types';
export declare const createDeleteWebAuthnCredentialClient: (config: ServiceClientFactoryInput) => (config: {
    ...
    [x: string]: unknown;
}, input: import("./types").DeleteWebAuthnCredentialInput) => Promise<DeleteWebAuthnCredentialCommandOutput>;
