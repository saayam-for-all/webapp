...
import type { DocumentType, GraphQLAuthMode } from '@aws-amplify/core/internals/utils';
...
export interface EventsChannel {
     ...
     *
     */
    subscribe(observer: SubscriptionObserver<any>, subOptions?: EventsOptions): Subscription;
    /**
     * @experimental API may change in future versions
     *
