import { AWSTemporaryCredentials, LocationCredentialsProvider } from '../../providers/s3/types/options';
 ...
 * @internal
 */
export type ListLocations = (input?: ListLocationsInput) => Promise<ListLocationsOutput>;
/**
 * @internal
 */
