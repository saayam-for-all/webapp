 ...
 */
export declare function list(contextSpec: AmplifyServer.ContextSpec, input: ListPaginateWithPathInput): Promise<ListPaginateWithPathOutput>;
/**
 ...
 * @throws validation: `StorageValidationErrorCode`  - thrown when there are issues with credentials
 */
export declare function list(contextSpec: AmplifyServer.ContextSpec, input: ListAllWithPathInput): Promise<ListAllWithPathOutput>;
/**
 ...
 * @throws validation: `StorageValidationErrorCode` - thrown when there are issues with credentials
 */
export declare function list(contextSpec: AmplifyServer.ContextSpec, input?: ListPaginateInput): Promise<ListPaginateOutput>;
/**
 * @deprecated The `prefix` and `accessLevel` parameters are deprecated and may be removed in the next major version.
 * Please use {@link https://docs.amplify.aws/react/build-a-backend/storage/list | path} instead.
 ...
 * @throws validation: `StorageValidationErrorCode`  - thrown when there are issues with credentials
 */
export declare function list(contextSpec: AmplifyServer.ContextSpec, input?: ListAllInput): Promise<ListAllOutput>;
