 ...
 *
 */
export declare function getUrl(contextSpec: AmplifyServer.ContextSpec, input: GetUrlWithPathInput): Promise<GetUrlWithPathOutput>;
/**
 ...
 *
 */
export declare function getUrl(contextSpec: AmplifyServer.ContextSpec, input: GetUrlInput): Promise<GetUrlOutput>;
