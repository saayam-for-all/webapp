...
exports.MixedType = exports.getFieldValue = exports.getFieldType = exports.arrayTypeSchemaSpec = exports.schemaSpecKey = void 0;
...
exports.arrayTypeSchemaSpec = 'arrayTypeSchemaSpec';
/**
...
function getFieldType(schemaSpec, fieldName, nestedObject) {
    if (nestedObject) {
        ...
        if (arrayMatch) {
            ...
            if (type === null || type === void 0 ? void 0 : type[exports.arrayTypeSchemaSpec]) {
                // If there are remaining paths and the type is ObjectType (has schemaSpecKey)
                if (namePath.length > 1 && type[exports.arrayTypeSchemaSpec][exports.schemaSpecKey]) {
                    return getFieldType(type[exports.arrayTypeSchemaSpec][exports.schemaSpecKey], namePath.slice(1).join('.'), true);
                }
                // Otherwise return the array element type directly
                return type[exports.arrayTypeSchemaSpec];
            }
            return type;
        }
        const joinedPath = namePath.join(`.${exports.schemaSpecKey}.`);
        return (0, utils_1.get)(schemaSpec, joinedPath);
    }
