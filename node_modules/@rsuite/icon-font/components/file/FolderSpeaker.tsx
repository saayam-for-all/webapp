...
function FolderSpeaker(props: React.SVGProps<SVGSVGElement>, svgRef?: React.Ref<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" ref={svgRef} {...props}>
      ...
      <path d="M15.867 7.751c.088.189.133.397.133.608v5.283c0 .75-.566 1.358-1.263 1.358-.196 0-.389-.049-.565-.143L12 13.689v.811c0 .782-.664 1.421-1.368 1.493L10.5 16c-.706 0-1.412-.592-1.492-1.355L9 14.5V13H7.842A.842.842 0 017 12.158V9.842C7 9.377 7.377 9 7.842 9h2.877l3.453-1.856c.624-.336 1.383-.064 1.695.608zM10.719 13H10v1.5c0 .216.21.443.421.491L10.5 15c.208 0 .441-.203.491-.419L11 14.5v-1.349L10.719 13zm3.982-4.996l-.056.02-3.646 1.96v2.031l3.646 1.961a.2.2 0 00.046.018l.046.006c.11 0 .225-.106.255-.271l.008-.087V8.359a.443.443 0 00-.018-.127l-.022-.059c-.062-.132-.164-.187-.259-.169zM10 10H8v2h2v-2z" />
    </svg>
  );
}

const ForwardRef = React.forwardRef(FolderSpeaker);
