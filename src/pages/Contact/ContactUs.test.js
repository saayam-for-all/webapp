...
jest.mock(
  ...
  () =>
    function PhoneNumberInputWithCountryMock(props) {
      // Test-only mock; production prop validation belongs to the real component.
      // eslint-disable-next-line react/prop-types
      const { phone, setPhone, error } = props;
...
describe("ContactUs", () => {
  ...
  it("clears the email error as soon as the email becomes valid", () => {
    render(<ContactUs />);
