      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex flex-col mb-4">
          <label className="font-bold mb-2">
            Please select one or more that reflect your gender
          </label>
          {isEditing ? (
            <Select
              isMulti
              ...
              value={genderOptions.filter((option) =>
                personalInfo.gender.includes(option.value)
              )}
        ...
        <div className="flex flex-col mb-4">
          ...
          {isEditing ? (
            <Select
              value={{
                value: personalInfo.languagePreference1,
                label: personalInfo.languagePreference1,
              }}
              options={languages}
        ...
        <div className="flex flex-col mb-4">
          ...
          {isEditing ? (
            <Select
              value={{
                value: personalInfo.languagePreference2,
                label: personalInfo.languagePreference2,
              }}
              options={languages}
              onChange={(selectedOption) =>
                handleInputChange(
