                ...
                <div>
                    ...
                    {isEditing ? (
                        <Select
                            ...
                            options={languages}
                            onChange={(selectedOption) =>
                                handleInputChange("languagePreference1", selectedOption?.value || "")
                            }
                            className="w-full"
                        />
                    ) : (
                ...
                <div>
                    ...
                    {isEditing ? (
                        <Select
                            ...
                            options={languages}
                            onChange={(selectedOption) =>
                                handleInputChange("languagePreference2", selectedOption?.value || "")
                            }
                            className="w-full"
                        />
                    ) : (
                ...
                <div>
                    ...
                    {isEditing ? (
                        <Select
                            ...
                            options={languages}
                            onChange={(selectedOption) =>
                                handleInputChange("languagePreference3", selectedOption?.value || "")
                            }
                            className="w-full"
                        />
                    ) : (
