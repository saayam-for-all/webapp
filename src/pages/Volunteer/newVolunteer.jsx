            ...
            <div>
                ...
                <div className="container">
                    <div className="tabbed-wizard">                    
                        <Tabs activeKey={key} onSelect={(k) => setKey(k)} transition={false} id="tab-wizard">
                            <Tab eventKey="pii" title="Personal information" disabled={!piiComplete}>
                                <Form onSubmit={handleSubmitPii}>
                                    <Form.Group controlId="piiForm">
                                    <Form.Label>Upload document: </Form.Label>
                                    <Form.Control type="file" name="pii_file" value={pii_file} onChange={(e)=> handleChange(e) } />      
                                    </Form.Group>
                                    <Button variant="primary" type="submit">Next</Button>
                                </Form>
                            </Tab>
                            <Tab eventKey="course" title="Saayam volunteer course" disabled={!courseComplete}>
                            ...
                            <Tab eventKey="tc" title="Terms & Conditions" disabled={!tcComplete}>
                                <Form onSubmit={handleSubmitTc}>
                                    <Form.Group controlId="tcForm">                                    
                                        <div className="mb-3">
                                            <Form.Check type='checkbox' id='agree' label='Read and agree the Terms & Conditions' onChange={(e) => handleChangeAgree(e) } />                                        
                                        </div>
                                    </Form.Group>
                                    <Button variant="secondary" onClick={handlePrev}>Previous</Button>{' '}
