    ...
    <div className="document-acknowledgment p-6">
      ...
      >
        <h3 className="font-bold text-lg mb-2">
          Volunteer Agreement for Saayam for All
        </h3>
        <div>
          ...
          This Volunteer Agreement ("Agreement") is entered into between Saayam
          for All ("Organization") and the volunteer ("Volunteer") upon
          acceptance. By signing or agreeing electronically, the Volunteer
          acknowledges their understanding and acceptance of the terms herein,
          which govern their participation in any volunteer activities with the
          Organization.
          <br />
          <h4 className="font-bold text-lg mb-2">
          ...
          The Volunteer agrees to fulfill the roles and responsibilities
          assigned by the Organization, which may include, but are not limited
          to, assisting in various tasks as needed by individuals or communities
          requesting help. The Volunteer agrees to: <br />
          - Engage in activities assigned by the Organization in a diligent,
          ...
          - Complete assigned tasks promptly and to the best of their ability,
          adhering to any specified deadlines.
          <br />
          <h4 className="font-bold text-lg mb-2">
            3. Code of Conduct
            <br />
          </h4>
          The Volunteer agrees to maintain the highest standards of ethical
          behavior while representing the Organization. This includes: <br />
          - Treating all individuals with respect and dignity, regardless of
          race, religion, gender, sexual orientation, age, or disability. <br />
          - Refraining from any form of discrimination, harassment, or
          unprofessional behavior. <br />
          - Avoiding conflicts of interest and ensuring that personal interests
          do not interfere with their volunteer duties. <br />
          <h4 className="font-bold text-lg mb-2">
            4. Confidentiality Agreement
            <br />
          </h4>
          The Volunteer acknowledges that during their service, they may be
          privy to confidential, proprietary, or personal information relating
          to the Organization, other volunteers, or individuals seeking
          assistance. The Volunteer agrees to: <br />
          - Maintain confidentiality of all information, both during & after the
          term of this Agreement. <br />
          - Use such information solely for the purpose of fulfilling their
          volunteer responsibilities. <br />
          - Not disclose any confidential information to third parties without
          the explicit written consent of the Organization. <br />
          <h4 className="font-bold text-lg mb-2">
            5. Data Protection and Privacy
            <br />
          </h4>
          The Volunteer agrees to comply with all applicable data protection
          laws and regulations, including but not limited to the General Data
          Protection Regulation (GDPR) or any other local data protection laws.
          The Volunteer agrees to: <br />
          - Handle all personal data in accordance with the Organization’s data
          protection policies. <br />
          - Protect the integrity and confidentiality of any personal data
          accessed during volunteer activities. <br />
          - Immediately report any data breaches or incidents of unauthorized
          access to the Organization. <br />
          <h4 className="font-bold text-lg mb-2">
          ...
          of the Organization. The Volunteer agrees to: <br />
          - Assign all rights, titles, and interests in such intellectual
          property to the Organization. <br />
          - Refrain from using, reproducing, or distributing any intellectual
          property created during their service without the Organization's
          explicit consent. <br />
          <h4 className="font-bold text-lg mb-2">
          ...
          to: <br />
          - Assume all risks associated with their volunteer activities,
          including any travel or transportation risks. <br />
          ...
          activities. <br />
          - Acknowledge that the Organization does not provide insurance
          coverage for volunteers, and the Volunteer is responsible for
          obtaining any necessary insurance. <br />
          <h4 className="font-bold text-lg mb-2">
            8. Indemnification
            <br />
          </h4>
