    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="w-full max-w-5xl p-12 bg-white rounded-lg shadow-lg mx-4 lg:mx-auto">
        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-4xl font-extrabold text-gray-900 mb-4">{organization.name}</h1>
          ...
          <div className="bg-blue-50 p-6 rounded-lg shadow-sm text-center w-48">
            <h2 className="text-5xl font-bold text-gray-800">{organization.rating}%</h2>
        ...
        <div className="mt-10">
          <h3 className="text-2xl font-bold text-gray-800 mb-3">Organization Mission</h3>
