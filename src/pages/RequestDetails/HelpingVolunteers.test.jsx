...
describe("HelpingVolunteers", () => {
  ...
  it("renders Zoom Meeting and Delete buttons with volunteer filter controls", async () => {
    render(<HelpingVolunteers />);

    expect(
      await screen.findByRole("combobox", {
        name: /Filter by: All Causes/i,
      }),
    ).toBeInTheDocument();

    expect(screen.getByText(/Zoom Meeting/i)).toBeInTheDocument();
